...
namespace JWWS\WPPF\Filepath\Subclasses\Unconfirmed_Filepath\Factory\Base_Factory\Subclasses\Immediate_Dir_PHP_Factory\Tests\Unit;
...
/**
 * @covers \JWWS\WPPF\Filepath\Subclasses\Unconfirmed_Filepath\Factory\Base_Factory\Subclasses\Immediate_Dir_PHP_Factory\Immediate_Dir_PHP_Factory
 *
 * @internal
 *
 * @small
...
final class Create extends TestCase {
    ...
    public function pass(string $arg): void {
        self::assertInstanceOf(
            ...
            actual: Immediate_Dir_PHP_Factory::of(path: $arg)->create(),
        );
    }
    ...
    public function throw(string $arg): void {
        ...
        Immediate_Dir_PHP_Factory::of(path: $arg)->create();
    }
