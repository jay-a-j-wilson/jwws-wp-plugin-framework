...
namespace JWWS\WPPF\Loader\Plugin\Sub_Value_Objects\Header\Subclasses\Version_Header\Factory;
...
final class Version_Header_Factory {
    ...
    public function create(): Version_Header {
        return Version_Header::of(
