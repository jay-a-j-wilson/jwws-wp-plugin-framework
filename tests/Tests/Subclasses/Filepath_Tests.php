...
final class Filepath_Tests extends Tests {
    ...
    private static function unconfirmed_filepath(): void {
        Filepath\Subclasses\Unconfirmed_Filepath\Unconfirmed_Filepath_Tests::run();
    }

    /**
     */
    private static function confirmed_filepath(): void {
        Filepath\Subclasses\Confirmed_Filepath\Confirmed_Filepath_Tests::run();
    }

    /**
     */
    private static function entire_directory(): void {
        Filepath\Sub_Value_Objects\Directory\Subclasses\Entire_Directory\Entire_Directory_Tests::run();
    }

    /**
     */
    private static function immediate_directory(): void {
        Filepath\Sub_Value_Objects\Directory\Subclasses\Immediate_Directory\Immediate_Directory_Tests::run();
    }
